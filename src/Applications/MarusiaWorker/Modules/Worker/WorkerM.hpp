...
private:
	...
	std::string __findSchedule(const std::string& app_id, const std::vector<std::pair<std::vector<std::string>, std::string >>& variants_target, const std::string& command, const bool& is_professors, const boost::json::object& session);
	...
	void __responseTypeAnalize(const std::string &response_type, const std::string& app_ip, const std::string& app_id, const std::string& command, const boost::json::object& session);
	void __dialogSessionsStep(const std::string& app_ip, const std::string &app_id,const std::string& command,const boost::json::object& session);
